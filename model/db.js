...
exports.init = function(){
    ...
    return connection.query("CREATE database if not exists test ").
		...
		then(connection.query("CREATE TABLE IF NOT EXISTS viajes (ID INT PRIMARY KEY AUTO_INCREMENT, CHOFER VARCHAR(50), LATLON POINT, DIR VARCHAR(200), monto decimal(6,2), fecha TIMESTAMP DEFAULT CURRENT_TIMESTAMP, CLIENTE VARCHAR(75))")).
